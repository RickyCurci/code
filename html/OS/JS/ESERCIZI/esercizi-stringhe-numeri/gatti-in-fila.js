...
var cats = 44
var inFile = 6 
var numberFile = Math.ceil(cats/inFile); 
var missingCats = (numberFile * inFile) - cats;
console.log(cats+" gatti si unirono in "+inFile+" da "+numberFile+" gatti tranne l'ultima che ne contiene "+missingCats)